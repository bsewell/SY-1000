...
customRenameDialog::customRenameDialog(QWidget *parent, QString hex0, QString hex1, QString hex2, QString hex3, QString length)
    : QDialog(parent)
{
    this->hex0 = hex0;
    this->hex1 = hex1;
    ...
    int dialogLength;
    QString dialogText;
    QRegularExpression ra( QString::fromUtf8( "[\x20-\x7F\xe2\x86\x92\xe2\x86\x90]{1,128}" ) );
    QRegularExpression rb( QString::fromUtf8( "[\x20-\x7F\xe2\x86\x92\xe2\x86\x90]{1,32}" ) );
    QRegularExpression rc( QString::fromUtf8( "[\x20-\x7F\xe2\x86\x92\xe2\x86\x90]{1,8}" ) );
    ...
    QList<QString> nameArray = sysxIO->getFileSource(this->hex0, this->hex1, this->hex2, this->hex3);
    QString name;
    l=l+x;
    for(int i = x;i<l;i++ )
    {
