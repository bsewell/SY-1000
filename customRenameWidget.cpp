...
customRenameWidget::customRenameWidget(QWidget *parent, QString hex0, QString hex1, QString hex2, QString hex3, QString length)
    : QWidget(parent)
...
void customRenameWidget::mouseReleaseEvent(QMouseEvent *event)
{
    ...
    {
        customRenameDialog *dialog = new customRenameDialog(this, this->hex0, this->hex1, this->hex2, this->hex3, this->length);
...
void customRenameWidget::updateName(QString name)
{
    ...
    sysxIO->setFileSource(hex0, hex1, hex2, hex3, hexData);
}
