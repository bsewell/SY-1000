...
menuPage_assign12::menuPage_assign12(QWidget *parent)
    : menuPage(parent)
{
    std::string st = QString("build Assign12 menu").toStdString();
...
void menuPage_assign12::setEditPages()
{
    ...
    editDetails()->page()->addKnob(0, 2, 1, 1, "10", hex1, "09", "59", "normal", "bottom", 70);// Wave Form Rate
    editDetails()->page()->addComboBox(0, 3, 1, 1, "10", hex1, "09", "5A");                    // Wave Form
    editDetails()->page()->addGroupBox(0, 0, 1, 1);
    editDetails()->page()->addStackField();
