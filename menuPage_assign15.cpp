...
menuPage_assign15::menuPage_assign15(QWidget *parent)
    : menuPage(parent)
{
    std::string st = QString("build Assign15 menu").toStdString();
...
void menuPage_assign15::setEditPages()
{
    ...
    editDetails()->page()->addKnob(0, 2, 1, 1, "10", hex1, "0B", "19", "normal", "bottom", 70);// Wave Form Rate
    editDetails()->page()->addComboBox(0, 3, 1, 1, "10", hex1, "0B", "1A");                    // Wave Form
    editDetails()->page()->addGroupBox(0, 0, 1, 1);
    editDetails()->page()->addStackField();
