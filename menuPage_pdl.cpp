...
void menuPage_pdl::setEditPages()
{
    ...
    editDetails()->addPage("Tables", "00", "02", "02", "00");       // ******************************************************************
    ...
    editDetails()->addPage("Tables", "00", "02", "02", "01"); // *********************************************************************
    ...
    editDetails()->addPage("Tables", "00", "02", "02", "02"); // *********************************************************************
    ...
    editDetails()->addPage("Tables", "00", "02", "02", "03"); // *********************************************************************
    ...
    editDetails()->addPage("Tables", "00", "02", "02", "04"); // *********************************************************************


    editDetails()->page()->newGroupBox("NUMBER 1 LED");
    editDetails()->page()->newStackControl(0);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "12"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(0, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(0, 1, 1, 2);

    editDetails()->page()->newStackField(0);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "01"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "00"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "01", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");  //spacer
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(0);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "01"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "00"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "01", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("NUMBER 2 LED");
    editDetails()->page()->newStackControl(1);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "13"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(1, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(0, 3, 1, 2);

    editDetails()->page()->newStackField(1);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "03"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "02"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "03", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(1);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "03"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "02"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "03", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("NUMBER 3 LED");
    editDetails()->page()->newStackControl(2);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "14"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(2, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(0, 5, 1, 2);

    editDetails()->page()->newStackField(2);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "05"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "04"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "05", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(2);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "05"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "04"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "05", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("NUMBER 4 LED");
    editDetails()->page()->newStackControl(3);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "15"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(3, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(0, 7, 1, 2);

    editDetails()->page()->newStackField(3);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "07"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "06"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "07", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(3);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "07"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "06"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "07", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "01", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("BANK DOWN LED");
    editDetails()->page()->newStackControl(4);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "16"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(4, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(1, 0, 1, 2);

    editDetails()->page()->newStackField(4);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "09"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "08"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "09", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "09", "10", "more_than");  //spacer
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(4);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "09"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "08"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "09", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "09", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("BANK UP LED");
    editDetails()->page()->newStackControl(5);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "17"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(5, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(1, 2, 1, 2);

    editDetails()->page()->newStackField(5);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "0B"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "0A"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "0B", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0B", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(5);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "0B"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "0A"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "0B", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0B", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("CTL 1 LED");
    editDetails()->page()->newStackControl(6);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "18"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(6, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(1, 4, 1, 2);

    editDetails()->page()->newStackField(6);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "0D"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "0C"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "0D", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0D", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(6);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "0D"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "0C"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "0D", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0D", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("CTL 2 LED");
    editDetails()->page()->newStackControl(7);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "19"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(7, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(1, 6, 1, 2);

    editDetails()->page()->newStackField(7);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "0F"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "0E"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "0F", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0F", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(7);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "0F"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "0E"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "0F", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "0F", "10", "more_than");
    editDetails()->page()->addStackField();

    editDetails()->page()->newGroupBox("CURRENT NUMBER LED");
    editDetails()->page()->newStackControl(8);
    editDetails()->page()->addTabBar(2, 0, 1, 1, "00", sys1, "20", "1A"); // patch~system preference
    editDetails()->page()->addStackControl();
    editDetails()->page()->insertStackField(8, 0, 0, 1, 1);
    editDetails()->page()->addGroupBox(1, 8, 1, 2);

    editDetails()->page()->newStackField(8);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hex1, "03", "11"); // patch led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "10", hex1, "03", "10"); // patch led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "10", hex1, "03", "11", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "11", "10", "more_than");
    editDetails()->page()->addStackField();
    editDetails()->page()->newStackField(8);
    editDetails()->page()->addComboBox(0, 0, 1, 1, "00", sys1, "20", "11"); // system led on
    editDetails()->page()->addComboBox(1, 0, 1, 1, "00", sys1, "20", "10"); // system led off
    editDetails()->page()->addSystemOverride(1, 0, 1, 1, "00", sys1, "20", "11", "08", "less_than");
    //editDetails()->page()->addSystemOverride(1, 1, 1, 1, "10", hex1, "03", "11", "10", "more_than");
    editDetails()->page()->addStackField();
