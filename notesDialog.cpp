    ...
    : QWidget(parent)
{
    ...
    setWindowTitle(tr("SY-1000 Patch notes"));//+ patchName);
}
...
notesDialog::~notesDialog()
{
    ...
    sysxIO->memo1Array.append(memo1Dialog->toPlainText().simplified().toLatin1());
    sysxIO->memo2Array.append(memo2Dialog->toPlainText().simplified().toLatin1());
    sysxIO->memo3Array.append(memo3Dialog->toPlainText().simplified().toLatin1());
    sysxIO->memo4Array.append(memo4Dialog->toPlainText().simplified().toLatin1());
    this->deleteLater();
}
