...
Rectangle {
    ...
    Flickable {
        ...
        Column {
            ...
            Row {
                spacing: 14
                SyComboBox { hex0: "10"; hex1: root.hex1; hex2: root.hex2; hex3: "1A" }
                SyComboBox { hex0: "10"; hex1: root.hex1; hex2: root.hex2; hex3: "1B"; implicitWidth: 100 }
                SyComboBox { hex0: "10"; hex1: root.hex1; hex2: root.hex2; hex3: "1C"; implicitWidth: 100 }
            }
            Grid {
                columns: 3
                columnSpacing: 14
