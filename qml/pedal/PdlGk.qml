...
Item {
    ...
    Flickable {
        ...
        Column {
            ...
            // GK VOLUME
            Rectangle { width: parent.width; height: 28; color: SyTheme.bgSectionHead; Text { x: 16; anchors.verticalCenter: parent.verticalCenter; text: "GK VOLUME"; color: SyTheme.textPrimary; font.pixelSize: 13; font.family: SyTheme.fontFamily; font.bold: true } }
            Item {
            ...
            Rectangle { width: parent.width; height: 28; color: SyTheme.bgSectionHead; Text { x: 16; anchors.verticalCenter: parent.verticalCenter; text: "GK VOLUME ASSIGN HOLD"; color: SyTheme.textPrimary; font.pixelSize: 13; font.family: SyTheme.fontFamily; font.bold: true } }
            Item {
                width: parent.width; height: 44
                Text { x: 32; anchors.verticalCenter: parent.verticalCenter; text: "GLOBAL"; color: SyTheme.textSysLabel; font.pixelSize: 11; font.family: SyTheme.fontFamily }
            ...
            // GK SWITCH 1
            Rectangle { width: parent.width; height: 28; color: SyTheme.bgSectionHead; Text { x: 16; anchors.verticalCenter: parent.verticalCenter; text: "GK SWITCH 1"; color: SyTheme.textPrimary; font.pixelSize: 13; font.family: SyTheme.fontFamily; font.bold: true } }
            Item {
                width: parent.width; height: 44
                Text { x: 32; anchors.verticalCenter: parent.verticalCenter; text: "SOURCE"; color: SyTheme.textSysLabel; font.pixelSize: 11; font.family: SyTheme.fontFamily }
            ...
            // GK SWITCH 2
            Rectangle { width: parent.width; height: 28; color: SyTheme.bgSectionHead; Text { x: 16; anchors.verticalCenter: parent.verticalCenter; text: "GK SWITCH 2"; color: SyTheme.textPrimary; font.pixelSize: 13; font.family: SyTheme.fontFamily; font.bold: true } }
            Item {
                width: parent.width; height: 44
                Text { x: 32; anchors.verticalCenter: parent.verticalCenter; text: "SOURCE"; color: SyTheme.textSysLabel; font.pixelSize: 11; font.family: SyTheme.fontFamily }
