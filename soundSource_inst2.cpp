...
void soundsource_inst2::setEditPages()
{
    ...
    editDetails()->page()->newGroupBox("Instrument 2");
    ...
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hex1,  hex2, "0F"); //wave type
    editDetails()->page()->addKnob(0, 1, 1, 1, "10", hex1,  hex2, "10"); //wave type
    editDetails()->page()->addKnob(0, 2, 1, 1, "10", hex1,  hex2, "11"); //wave type
    editDetails()->page()->addSystemOverride(0, 0, 1, 3, "10", hex1,  hex2, "00", "00");
...
void soundsource_inst2::stringLevels()
{
    ...
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hexA, hexB, "0A", "normal_ratio1.5");  //5
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "10", "normal_ratio1.5");  //5
    editDetails()->page()->addGroupBox(0, 1, 1, 1);
    editDetails()->page()->newGroupBox(str4);
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hexA, hexB, "09", "normal_ratio1.5");  //4
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0F", "normal_ratio1.5");  //4
    editDetails()->page()->addGroupBox(0, 2, 1, 1);
    editDetails()->page()->newGroupBox(str3);
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hexA, hexB, "08", "normal_ratio1.5");  //3
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0E", "normal_ratio1.5");  //3
    editDetails()->page()->addGroupBox(0, 3, 1, 1);
    editDetails()->page()->newGroupBox(str2);
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hexA, hexB, "07", "normal_ratio1.5");  //2
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0D", "normal_ratio1.5");  //2
    editDetails()->page()->addGroupBox(0, 4, 1, 1);
    editDetails()->page()->newGroupBox(str1);
    editDetails()->page()->addKnob(0, 0, 1, 1, "10", hexA, hexB, "06", "normal_ratio1.5");  //string 1
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0C", "normal_ratio1.5");  //string 1
...
void soundsource_inst2::altTuning()
{
    ...
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0D");                    // fine 6
    ...
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0C");                    // fine 5
    ...
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0B");                    // fine 4
    ...
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "0A");                    // fine 3
    ...
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "09");                    // fine 2
    editDetails()->page()->addGroupBox(0, 5, 2, 1);
    editDetails()->page()->newGroupBox(str1+" Tuning");
    editDetails()->page()->addComboBox(0, 0, 1, 1, "10", hexA, hexB, "02", "large");       // pitch 1
    editDetails()->page()->addKnob(1, 0, 1, 1, "10", hexA, hexB, "08");                    // fine 1
    ...
    editDetails()->page()->addSystemOverride(0, 1, 2, 6, "10", hexA, hexB, "01", usr, "not_equals");
