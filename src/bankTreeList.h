...
public slots:
    ...
    void updateTree();
    void setBankListMode(int index);
...
private:
    ...
    QList<QTreeWidgetItem*> presetItems;
    QStringList presetNames;
    bool presetModeActive;
    void closeChildren(QTreeWidgetItem *item);
    QTreeWidget* newTreeList();
    QTreeWidget* newTreeList_Bass();
    void populateTreeForMode(bool presetMode);
    ...
    bool autoLoadStartupUserPatchPending;
    void autoLoadStartupUserPatch();
