...
menuPage_assign13::menuPage_assign13(QWidget *parent)
    : menuPage(parent)
{
    std::string st = QString("build Assign13 menu").toStdString();
...
void menuPage_assign13::setEditPages()
{
    ...
    editDetails()->page()->addKnob(0, 2, 1, 1, "10", hex1, "0A", "19", "normal", "bottom", 70);// Wave Form Rate
    editDetails()->page()->addComboBox(0, 3, 1, 1, "10", hex1, "0A", "1A");                    // Wave Form
    editDetails()->page()->addGroupBox(0, 0, 1, 1);
    editDetails()->page()->addStackField();
