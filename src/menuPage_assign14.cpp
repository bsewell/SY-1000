...
menuPage_assign14::menuPage_assign14(QWidget *parent)
    : menuPage(parent)
{
    std::string st = QString("build Assign14 menu").toStdString();
...
void menuPage_assign14::setEditPages()
{
    ...
    editDetails()->page()->addKnob(0, 2, 1, 1, "10", hex1, "0A", "59", "normal", "bottom", 70);// Wave Form Rate
    editDetails()->page()->addComboBox(0, 3, 1, 1, "10", hex1, "0A", "5A");                    // Wave Form
    editDetails()->page()->addGroupBox(0, 0, 1, 1);
    editDetails()->page()->addStackField();
