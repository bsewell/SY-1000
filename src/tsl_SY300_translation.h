...
#ifndef TSL_SY300_TRANSLATION_H
#define TSL_SY300_TRANSLATION_H
...
class tsl_translation : public QWidget
{
    Q_OBJECT

public:
    tsl_translation(QByteArray patch, QByteArray default_hex, int mode, QString filename);
    ~tsl_translation();
...
private: 
    ...
    void SY1K_hex_replace(int pos, int size, QByteArray value);
    QString headerType;
